...
<script setup lang="ts">
  ...
  interface ArtTableProps extends Omit<TableProps<Record<string, any>>, 'tableLayout'> {
    // Element Plus Table has a required `tableLayout` in its type definitions in this project.
    // Make it optional for ArtTable to avoid forcing callers to always supply it.
    tableLayout?: TableProps<Record<string, any>>['tableLayout']
    /** 加载状态 */
    loading?: boolean
    /** 列渲染配置 */

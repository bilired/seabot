...
urlpatterns = [
    ...
    path('ship/video-stream-monitor/start/', views.video_stream_monitor_start, name='video_stream_monitor_start'),
    path('ship/video-stream-monitor/status/', views.video_stream_monitor_status, name='video_stream_monitor_status'),

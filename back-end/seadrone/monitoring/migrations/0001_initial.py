# Generated by Django 5.2.10 on 2026-02-23 13:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ship_model', models.CharField(help_text='船型号', max_length=50)),
                ...
                ('error_code1', models.CharField(default='00', help_text='错误码1', max_length=10)),
                ('error_code2', models.CharField(default='00', help_text='错误码2', max_length=10)),
                ('instrument_status', models.CharField(default='正常', help_text='仪器状态', max_length=20)),
                ('collection_time', models.DateTimeField(auto_now_add=True, help_text='采集时间')),
                ('connection_status', models.CharField(default='在线', help_text='连接状态', max_length=20)),
            ],
            options={
                'verbose_name': '营养盐数据',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('warning_code', models.CharField(default='正常', help_text='警告码', max_length=50)),
                ('collection_time', models.DateTimeField(auto_now_add=True, help_text='采集时间')),
                ('connection_status', models.CharField(default='在线', help_text='连接状态', max_length=20)),
            ],
            options={
